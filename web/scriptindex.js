...
var myCards = [];
var me = {};
var targetableList = ['atak', 'przerzut', 'uzdrowienie', 'wymiana_kart', 'nowonarodzony','zamiana','rzut','trening','gruboskorny','nadwrazliwy','berserk','superwytrzymaly', 'kot', 'oslabienie'];
var specialCases = {};
var hierarchy = {};
var cardsInCW ={};
/*jshint sub:true */

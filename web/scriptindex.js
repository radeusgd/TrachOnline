...
var myCards = [];
var me = {};
var targetableList = ['atak', 'przerzut', 'uzdrowienie', 'potezne_uzdrowienie', 'pelna_regeneracja', 'wymiana_kart', 'nowonarodzony','zamiana','rzut','trening','gruboskorny','nadwrazliwy','berserk', 'wampir','superwytrzymaly', 'kot', 'oslabienie','wielka_lapa','mala_lapka','szpieg'];
var specialCases = {};
var hierarchy = {};
var cardsInCW ={};
/*jshint sub:true */
